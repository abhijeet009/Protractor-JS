...
describe('Board page',function(){
  ...
  let vars
    ...
    it('writing using pen', async()=>{
      browser.driver.sleep(3000);
      //boardOperations.clickBoard();
      console.log("into drawing");
      await driver.findElement(By.xpath("//li[@class='sub-tool-list pen-tool box-height tip-disable active']")).click()
      await driver.findElement(By.xpath("//a[@class='tool-pen']")).click()
      {
       // const element = await driver.findElement(By.css("#rectZoom"))
        await driver.actions({ bridge: true }).moveToElement().clickAndHold().perform()
      }
      {
        const element = await driver.findElement(By.css("#rectZoom"))
      ...
      await driver.findElement(By.css("#rectZoom")).click()
      {
        const element = await driver.findElement(By.css("#rectZoom"))
